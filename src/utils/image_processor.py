...
class ImageProcessor:
    """
    A class to handle operations related to FITS images and image generation.
    """
    ...
    def generate_images(self, model, input_image_tensor, target_image_tensor, input_filename, image_path, mode="train"):
        """
